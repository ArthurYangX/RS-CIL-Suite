...
from benchmark.protocols.cil import PROTOCOLS, CILProtocol
...
def run(args):
    ...
    # ── Method ────────────────────────────────────────────────────
    method = _build_method(args.method, protocol, device, datasets)
...
def _build_method(name: str, protocol: CILProtocol, device, datasets):
    ...
    registry = {
        "finetune": lambda: _import("benchmark.methods.finetune", "FineTune")(**kwargs),
        "joint":    lambda: _import("benchmark.methods.joint",    "JointTraining")(**kwargs),
        "ncm":      lambda: _import("benchmark.methods.ncm",      "NCMMethod")(**kwargs),
        "ewc":      lambda: _import("benchmark.methods.ewc",      "EWC")(**kwargs),
        "lwf":      lambda: _import("benchmark.methods.lwf",      "LwF")(**kwargs),
        "si":       lambda: _import("benchmark.methods.si",       "SI")(**kwargs),
        "icarl":    lambda: _import("benchmark.methods.icarl",    "iCaRL")(**kwargs),
        "der":      lambda: _import("benchmark.methods.der",      "DERpp")(**kwargs),
        "gdumb":    lambda: _import("benchmark.methods.gdumb",    "GDumb")(**kwargs),
        "lucir":    lambda: _import("benchmark.methods.lucir",    "LUCIR")(**kwargs),
